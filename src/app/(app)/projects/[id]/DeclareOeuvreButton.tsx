...
import { declareOeuvreAction } from "../../sacem-actions";
import type { ActionState } from "../../actions";

export function DeclareOeuvreButton({ versionId }: { versionId: string }) {
  ...
  return (
    <form action={action} className="flex items-center gap-2">
      ...
      >
        {pending ? "Déclaration…" : "Déclarer l'œuvre à la SACEM"}
      </button>
